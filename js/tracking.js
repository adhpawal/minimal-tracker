(function (context, trackingId, options) {
    ...
    const track = (
        ...
        const url = 'https://minimalistic-tracker-git-main-adhpawal.vercel.app/api/ping';
    ...
    .querySelector('script[data-id="minTracker"][data-trackingID]')
    .getAttribute('data-trackingID'), {
    anonymizeIp: false,
    colorDepth: true,
    characterSet: true,
    screenSize: true,
